...
LOG_TYPE_REGEX = Regex(
    ...
    r"\.GuardDuty|AWS\.S3ServerAccess|AWS\.VPCDns|AWS\.VPCFlow|AWS\.WAFWebACL|Box\.Event|CiscoUmbrella"
    r"\.CloudFirewall|CiscoUmbrella\.DNS|CiscoUmbrella\.IP|CiscoUmbrella\.Proxy|Cloudflare"
    r"\.Firewall|Cloudflare\.HttpRequest|Cloudflare\.Spectrum|Crowdstrike\.ActivityAudit|Crowdstrike"
    r"\.AIDMaster|Crowdstrike\.AppInfo|Crowdstrike\.CriticalFile|Crowdstrike"
    r"\.DNSRequest|Crowdstrike\.DetectionSummary|Crowdstrike\.GroupIdentity|Crowdstrike\.ManagedAssets"
    r"|Crowdstrike\.NetworkConnect|Crowdstrike\.NetworkListen|Crowdstrike\.NotManagedAssets|Crowdstrike"
    r"\.ProcessRollup2|Crowdstrike\.ProcessRollup2Stats|Crowdstrike\.SyntheticProcessRollup2|Crowdstrike"
    r"\.Unknown|Crowdstrike\.UserIdentity|Crowdstrike\.UserInfo|Crowdstrike\.UserLogonLogoff|Duo\.Administrator|Duo"
    ...
    r"|Juniper\.Postgres|Juniper\.Security|Lacework\.AlertDetails|Lacework\.CloudCompliance|Lacework\.Events"
    r"|Microsoft365\.Audit\.AzureActiveDirectory|Microsoft365\.Audit\.Exchange|Microsoft365\.Audit\.General"
    r"|Microsoft365\.Audit\.SharePoint|Microsoft365\.DLP\.All|Nginx\.Access|Okta\.SystemLog|OneLogin\.Events"
    r"|Osquery\.Batch|Osquery\.Differential|Osquery\.Snapshot|Osquery\.Status|OSSEC\.EventInfo|Salesforce\."
