...
class TestCaseEvaluator:
    ...
    def interpret(self, ignore_exception_types: List[Type[Exception]] = None) -> TestResult:
        ...
        if self._spec.expectations.detection == self._get_detection_alert_value():
            ...
            if self._detection_result.title_defined:
            ...
            if self._detection_result.description_defined:
                function_results.update(
                    dict(
            ...
            if self._detection_result.reference_defined:
                function_results.update(
                    dict(
            ...
            if self._detection_result.severity_defined:
                function_results.update(
                    dict(
            ...
            if self._detection_result.runbook_defined:
                function_results.update(
                    dict(
